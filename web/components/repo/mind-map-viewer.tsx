...
/**
 * Parse mind map content into tree structure
 */
...
const LEVEL_GAP_H = 120; // Horizontal level gap
const NODE_GAP_V = 8; // Vertical node gap
...
function calculateLayout(
  ...
  // Distribute left/right nodes - simple alternating
  ...
  // Calculate total height of both sides
...
function drawMindMap(
  ...
  // Draw connection lines - from parent to child
  const drawConnections = (parent: LayoutNode) => {
    parent.children.forEach(child => {
      ...
      // Recursively draw child node connections
