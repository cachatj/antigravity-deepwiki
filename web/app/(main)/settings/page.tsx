...
export default function SettingsPage() {
  ...
  const handleLanguageChange = (value: string) => {
    ...
    // Language switch handled by LanguageToggle component, only save settings here
  };
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t("settings.appearanceDescription") || "Customize the look and feel of the app"}
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t("settings.themeDescription") || "Choose the color theme"}
                  </p>
                </div>
