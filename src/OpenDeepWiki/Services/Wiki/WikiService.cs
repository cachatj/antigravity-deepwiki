...
public class WikiService(IContext context)
{
    ...
    /// <summary>
    /// Gets the Wiki catalog structure.
    /// </summary>
    ...
    /// <summary>
    /// Gets the Wiki document content.
    /// </summary>
    ...
    public async Task<WikiDocResponse> GetDocAsync(string org, string repo, string path)
    {
        ...
        if (catalog is null)
        {
            throw new KeyNotFoundException($"Document path '{normalizedPath}' not found");
        }
    ...
    private async Task<RepositoryBranch> GetDefaultBranchAsync(string repositoryId)
    {
        ...
        if (branches.Count == 0)
        {
            throw new KeyNotFoundException("Repository branch not found");
        }
    ...
    private async Task<BranchLanguage> GetDefaultLanguageAsync(string branchId)
    {
        ...
        {
            throw new KeyNotFoundException("Repository language not found");
        }
