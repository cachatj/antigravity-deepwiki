...
public class WikiGeneratorOptions
{
    ...
    /// Example: "en". Can be configured via WIKI_LANGUAGES environment variable.
    ...
    /// </summary>
    public AiRequestType? CatalogRequestType { get; set; } = AiRequestType.Gemini;

    /// <summary>
    /// The request type for content generation (e.g., OpenAI, Azure, Claude).
    /// If not set, uses the default request type.
    /// </summary>
    public AiRequestType? ContentRequestType { get; set; } = AiRequestType.Gemini;
    ...
    /// </summary>
    public AiRequestType? TranslationRequestType { get; set; } = AiRequestType.Gemini;
